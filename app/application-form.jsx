...
const formSchema = z.object({
  ...
  // Previous Employment
  job1CompanyName: z.string().min(1, "Required Field"),
  job1Address: z.string().min(1, "Required Field"),
  job1PostCode: z.string().min(1, "Required Field"),
  job1Tel: z.string().min(1, "Required Field"),
  job1Position: z.string().min(1, "Required Field"),
  job1Manager: z.string().min(1, "Required Field"),
  job1From: z.string().min(1, "Required Field"),
  job1To: z.string().min(1, "Required Field"),
  job1ReasonForLeaving: z.string().min(1, "Required Field"),
  job1Email: z.string().min(1, "Required Field"),
  job1EmailReplyDate: z.string().min(1, "Required Field"),
  job1EmailReply: z.string().min(1, "Required Field"),

  job2CompanyName: z.string().min(1, "Required Field"),
  job2Address: z.string().min(1, "Required Field"),
  job2PostCode: z.string().min(1, "Required Field"),
  job2Tel: z.string().min(1, "Required Field"),
  job2Position: z.string().min(1, "Required Field"),
  job2Manager: z.string().min(1, "Required Field"),
  job2From: z.string().min(1, "Required Field"),
  job2To: z.string().min(1, "Required Field"),
  job2ReasonForLeaving: z.string().min(1, "Required Field"),
  job2Email: z.string().min(1, "Required Field"),
  job2EmailReplyDate: z.string().min(1, "Required Field"),
  job2EmailReply: z.string().min(1, "Required Field"),
